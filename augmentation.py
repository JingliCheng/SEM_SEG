...
class GeometricTransform:
    ...
    def __call__(self, image, mask):
        transforms = self.geometric_transform(
    ...
    def geometric_transform(self, output_size=(224, 224), scale=(0.3, 2.0), ratio=(0.75, 1.33), flip=True, rotate=True, color_jitter=True, random_erasing=True):
...
class ColorTransform:
    ...
    def __call__(self, image, mask):
        transforms = self.color_transform(
